...
/// Functions to query BussinessTypeRecords (as a Stream and as a Future).
Stream<List<BussinessTypeRecord>> queryBussinessTypeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BussinessTypeRecord.collection,
...
Future<List<BussinessTypeRecord>> queryBussinessTypeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<BussinessTypeRecord>> queryBussinessTypeRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query PaymentScreenshotsRecords (as a Stream and as a Future).
Stream<List<PaymentScreenshotsRecord>> queryPaymentScreenshotsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PaymentScreenshotsRecord.collection,
...
Future<List<PaymentScreenshotsRecord>> queryPaymentScreenshotsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<PaymentScreenshotsRecord>>
    queryPaymentScreenshotsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
